...
1.  Ensure you have **SQL Server (SSMS)** or a compatible SQL environment installed.
2.  Run the script provided in the main repository (e.g., `OnlineStore_Setup.sql`).
3.  The script will automatically create the `OnlineStore10` database and populate all tables with initial data.

---

##  Note on Data
The dataset used in this project is **synthetic**, designed to reflect real-world business logic and relational complexity. It was generated using AI tools to test the database's integrity, relational constraints, and query performance in a controlled environment.
